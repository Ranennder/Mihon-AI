...
object SettingsReaderScreen : SearchableSettings {
    ...
    private fun getDisplayGroup(readerPreferences: ReaderPreferences): Preference.PreferenceGroup {
        ...
        val remoteAiUrlSubtitle = remoteAiServerUrlPreferenceSubtitle(
            manualUrl = remoteAiBaseUrl,
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = persistentListOf(
                ...
                Preference.PreferenceItem.SwitchPreference(
                    preference = readerPreferences.upscalePagesX2,
                    title = stringResource(MR.strings.pref_reader_upscale_x2),
                    subtitle = stringResource(MR.strings.pref_reader_upscale_x2_summary),
                ),
                Preference.PreferenceItem.CustomPreference(
                    title = stringResource(MR.strings.pref_reader_ai_backend),
                ) {
                    BasePreferenceWidget {
                        AiBackendSelector(
                            selectedMode = aiBackendMode,
                            enabled = upscaleEnabled,
                            onModeSelected = readerPreferences::setSelectedAiBackendMode,
                        )
                    }
                },
                Preference.PreferenceItem.EditTextPreference(
                    preference = readerPreferences.remoteAiBaseUrl,
                    title = stringResource(MR.strings.pref_reader_ai_remote_url),
                    subtitle = remoteAiUrlSubtitle,
                    allowBlank = true,
                    enabled = upscaleEnabled && aiBackendMode == ReaderPreferences.AiBackendMode.REMOTE,
                ),
                Preference.PreferenceItem.ListPreference(
                    preference = readerPreferences.remoteAiModel,
                    entries = ReaderPreferences.RemoteAiModel.entries
