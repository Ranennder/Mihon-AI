    ...
    override fun Content() {
        ...
        Scaffold(
            ...
            ScrollbarLazyColumn(
                ...
                item {
                    TextPreferenceWidget(
                        title = stringResource(MR.strings.about_based_on_mihon),
                        subtitle = BuildConfig.UPSTREAM_VERSION_NAME,
                    )
                }
    ...
    fun getVersionName(withBuildDate: Boolean): String {
        val details = buildList {
            if (BuildConfig.DEBUG || isPreviewBuildType) {
                add("r${BuildConfig.COMMIT_COUNT}")
                add(BuildConfig.COMMIT_SHA)
            }
            if (withBuildDate) {
                add(getFormattedBuildTime())
            }
        }
        ...
        return if (details.isEmpty()) {
            ...
            "${BuildConfig.APP_VERSION_NAME} (${details.joinToString(", ")})"
        }
    }
